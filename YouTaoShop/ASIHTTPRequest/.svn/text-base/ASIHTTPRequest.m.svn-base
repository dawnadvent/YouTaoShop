...
- (void)requestStarted
{
	...
	if ([self delegate] && [delegate respondsToSelector:didStartSelector]) {
...
- (void)requestReceivedResponseHeaders:(NSMutableDictionary *)newResponseHeaders
{
	...
	if ([self delegate] && [delegate respondsToSelector:didReceiveResponseHeadersSelector]) {
...
- (void)requestWillRedirectToURL:(NSURL *)newURL
{
	...
	if ([self delegate] && [delegate respondsToSelector:willRedirectSelector]) {
...
- (void)reportFinished
{
	if ([self delegate] && [delegate respondsToSelector:didFinishSelector]) {
...
- (void)reportFailure
{
	if ([self delegate] && [delegate respondsToSelector:didFailSelector]) {
...
{
	if ([self delegate] && [delegate respondsToSelector:didReceiveDataSelector]) {
