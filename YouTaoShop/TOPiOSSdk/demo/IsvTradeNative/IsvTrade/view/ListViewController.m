...
{
    [super viewDidLoad];
    tradeList = [[NSMutableArray alloc]initWithCapacity:10];
...
//    self.tableView.separatorStyle=UITableViewCellSeparatorStyleSingleLine;  
    ...
    // self.navigationtrade.rightBarButtontrade = self.editButtontrade;
}

- (void)viewWillAppear:(BOOL)animated
{
    if([[LoginUserInfo sharedInstance]userId]!=nil){
        tradeList = [[TradeDO initList]retain];
...
{
    NSLog(@"tradeList.count = %d",tradeList.count);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.selectionStyle=UITableViewCellSelectionStyleNone;
     [cell fillData:[tradeList objectAtIndex:[indexPath row]]];
    return cell;
}
...
{
    // Return NO if you do not want the specified trade to be editable.
    return YES;
}
*/
...
{
    // Return NO if you do not want the trade to be re-orderable.
    return YES;
}
*/
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [detailViewController setTrade:[tradeList objectAtIndex:[indexPath row]]];
//    [detailViewController fillData:[tradeList objectAtIndex:[indexPath row]]];
